    ...
    <div class="box-container">
      ...
      <div class="box">
          ...
          <?php
               ...
               foreach($products as $product){
                  ...
                  if(mysqli_num_rows($product_query) > 0){
                     ...
                     $category = isset($product_data['category']) ? ucfirst($product_data['category']) : 'Uncategorized';
                     echo '<p>' . htmlspecialchars($product_data['name']) . ' (' . htmlspecialchars($category) . ')</p>';
        ...
        <form action="" method="post">
          ...
          <a href="admin_pending_orders.php?delete=<?php echo $fetch_orders['id']; ?>"
